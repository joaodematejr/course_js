...
export class WhatsAppController {
  ...
  initEvents() {
    ...
    this.el.formPanelAddContact.on('submit', (e) => {
      e.preventDefault()
      let formtData = new FormData(this.el.formPanelAddContact)
    })
        ...
        this._documentPreviewController
          ...
          .catch((err) => {
            ...
            switch (file.type) {
              ...
              default:
                this.el.iconPanelDocumentPreview.className =
                  'jcxhw aumenta icon-doc-generic'
                break
            }
    ...
    this.el.btnSendMicrophone.on('click', (e) => {
      ...
      this._microphoneControler.on('play', (musica) => {
        console.log('sended', musica)
      })
    })

    this.el.btnCancelMicrophone.on('click', (e) => {
      this._microphoneControler.stop()
